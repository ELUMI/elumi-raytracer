...
SphereMap::SphereMap(float*** hdrdata, unsigned int width) {
  ...
  //  L00  = vec3( 0.078908f,  0.043710f,  0.054161f );
  //  L1_1 = vec3( 0.039499f,  0.034989f,  0.060488f );
  //  L10  = vec3(-0.033974f, -0.018236f, -0.026940f );
  //  L11  = vec3(-0.029213f, -0.005562f,  0.000944f );
  //  L2_2 = vec3(-0.011141f, -0.005090f, -0.012231f );
  //  L2_1 = vec3(-0.026240f, -0.022401f, -0.047479f );
  //  L20  = vec3(-0.015570f, -0.009471f, -0.014733f );
  //  L21  = vec3( 0.056014f,  0.021444f,  0.013915f );
  //  L22  = vec3( 0.021205f, -0.005432f, -0.030374f );
